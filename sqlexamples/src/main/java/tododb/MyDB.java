...
public class MyDB {
    ...
    public Connection create() {
        ...
        try {
            ...
            stm.execute("CREATE TABLE users(id INT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(255), password VARCHAR(255));");
            stm.execute("INSERT INTO users(name, password) VALUES('admin', 'root');");
            stm.execute("INSERT INTO users(name, password) VALUES('bob', 'dobbs');");
